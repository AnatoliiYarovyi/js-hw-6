...
// я тоже сразу не въехал.но когда понял, все пошло, как по маслу) ты изначально код писал,
// и деструктуризации норм применил.array.map(({ что нужно деструктуризировать }) => что нужно вернуть)
